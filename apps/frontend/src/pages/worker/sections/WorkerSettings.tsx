  ...
  const sections = [
    ...
    },
    {
      ...
      content: (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          {[
            { label: 'Nuevo trabajo disponible', desc: 'Recibir alerta cuando haya trabajos nuevos' },
            { label: 'Solicitud de contratación', desc: 'Notificar cuando un cliente quiera contratarme' },
            { label: 'Mensajes nuevos', desc: 'Alertar cuando reciba un mensaje nuevo' },
            { label: 'Actualizaciones del perfil', desc: 'Notificar cambios en el estado de mi perfil' },
          ].map((item, i) => (
    ...
    },
    {
      ...
      content: (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          {[
            { label: 'Perfil público', desc: 'Permitir que los clientes vean mi perfil' },
            { label: 'Mostrar disponibilidad', desc: 'Indicar si estoy disponible para trabajos' },
            { label: 'Mostrar calificación', desc: 'Mostrar mi rating promedio en el marketplace' },
          ].map((item, i) => (
            <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 0', borderBottom: '1px solid #efeeea' }}>
              <div>
                <p style={{ fontWeight: 600, color: '#061a07', fontSize: 15, marginBottom: 2 }}>{item.label}</p>
  ...
  return (
    ...
    >
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ color: '#737971', fontSize: 14 }}>Administra tu cuenta y preferencias</p>
      </div>
